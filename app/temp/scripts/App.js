...
var _FormThankyou = __webpack_require__(7);

var _FormThankyou2 = _interopRequireDefault(_FormThankyou);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mobileMenu = new _MobileMenu2.default();

new _RevealOnScroll2.default($('.meet-our-team__content'), '65%');
new _RevealOnScroll2.default($('.accommodation__content-inner'), '85%');
new _RevealOnScroll2.default($('.case-study__col'), '85%');
new _SmoothScroll2.default();

var formThankyou = new _FormThankyou2.default();
...
var FormThankyou = function () {
    function FormThankyou() {
        _classCallCheck(this, FormThankyou);

        this.events();
    }

    _createClass(FormThankyou, [{
        key: 'events',
        value: function events() {
